...
\def\org{{\texttt{ONR\ }}}
\def\orge{{\texttt{ONR}}}
\def\univ{{\texttt{UPorto/INEGI\ }}}
\def\unive{{\texttt{UPorto/INEGI}}}
\def\colo{{\texttt{Columbia\ }}}
\def\coloe{{\texttt{Columbia}}}
\def\now{{\texttt{NOW\ }}}
\def\nowe{{\texttt{NOW}}}
\def\oldproj{{\textbf{FRESNEL\ }}}
\def\oldproje{{\textbf{FRESNEL}}}
\def\proj{{\textbf{FRESNEL-II\ }}}
\def\proje{{\textbf{FRESNEL-II}}}
\def\rep{{\textbf{REPMUS\ }}}
\def\repe{{\textbf{REPMUS}}}
\def\ulis{{\texttt{ULisbon\ }}}
\def\ulise{{\texttt{ULisbon}}}
\def\IST{{\texttt{ULisbon/IST\ }}}
\def\ISTe{{\texttt{ULisbon/IST}}}
\def\nows{{\texttt{NOW Systems\ }}}
\def\nowse{{\texttt{NOW Systems}}}
