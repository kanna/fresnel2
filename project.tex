...
In 2024, the execution of the \org funded \oldproj showed that ocean
model driven \emph{adaptive} exploration, to drive targeted sampling
with gather data assimilated back into the model in a virtuous
\emph{sample-assimilate-predict-direct} to target the next round of
predicted uncertainty, could enhance model skill. 
